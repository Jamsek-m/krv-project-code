...
INSERT INTO clients(id, timestamp, client_id, name, redirect_uris, require_consent, secret, status, type, pkce_method, web_origins) VALUES ('13467961-3d7f-43bf-9cbd-19c7199977de', NOW(), 'admin-console', 'Admin Console', 'http://localhost:4200/callback/oidc', false, '7d9034a6-2e62-4468-92cb-b5e56b95edf1', 'ENABLED', 'PUBLIC', 'S256', 'http://localhost:4200;http://localhost:8080');
